        ...
        private static Theme[] BuildAll()
        {
            return new[]
            {
                new Theme
                {
                    ...
                    Run = C(0xE0, 0x52, 0x7D), Shadow = C(36, 0x8A, 0x72, 0x5A), InputBg = Color.White,
                    ...
                    DangerTop = C(0xFC, 0xA5, 0xA5), DangerBottom = C(0xF8, 0x71, 0x71),
                ...
                new Theme
                {
                    ...
                    Ink = C(0xF0, 0xEC, 0xE4), InkSoft = C(0xA9, 0xA2, 0xC0), Line = C(0x4A, 0x47, 0x78),
